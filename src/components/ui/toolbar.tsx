...
const ToolbarButton = forwardRef<HTMLButtonElement, ToolbarButtonProps>(
  (
    { children, size = 'icon', variant = 'ghost', className, tooltip, tooltipShortcut, activeClassname, active, ...rest },
    ref,
  ) => {
    const buttonClass = cn('gap-1 min-w-[2rem] px-2 w-auto', active && activeClassname, className)
